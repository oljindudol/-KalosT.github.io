...
const Rl = {
        ...
        methods: {
            onKeyPress(e) {
                e.key == "1" && this.phaseSelect(1), e.key == "2" && this.phaseSelect(2), e.key == "3" && this.phaseSelect(3), e.key == "4" && this.phaseSelect(4), (e.key == "d" || e.key == "D") && this.updateTrigger(11), (e.key == "f" || e.key == "F") && this.updateTrigger(12), (e.key == "g" || e.key == "G") && this.updateTrigger(13), this.phase == "1" && ((e.key == "q" || e.key == "Q") && this.updateTrigger(0), (e.key == "w" || e.key == "W") && this.updateTrigger(1), (e.key == "e" || e.key == "E") && this.updateTrigger(2)), this.phase == "2" && ((e.key == "q" || e.key == "Q") && this.updateTrigger(3), (e.key == "w" || e.key == "W") && this.updateTrigger(4), (e.key == "e" || e.key == "E") && this.updateTrigger(5), (e.key == "r" || e.key == "R") && this.updateTrigger(6)), this.phase == "3" && ((e.key == "q" || e.key == "Q") && this.updateTrigger(7), (e.key == "w" || e.key == "W") && this.updateTrigger(8), (e.key == "e" || e.key == "E") && this.updateTrigger(9)), this.phase == "4" && (e.key == "q" || e.key == "Q") && this.updateTrigger(10)
            },
            phaseSelect(e) {
                this.phase = e, e == 1 && (this.timeTrigger[0] = this.timePassed, this.timeTrigger[1] = this.timePassed, this.timeTrigger[2] = this.timePassed), e == 2 && (this.timeTrigger[3] = this.timePassed, this.timeTrigger[4] = this.timePassed, this.timeTrigger[5] = this.timePassed, this.timeTrigger[6] = this.timePassed), e == 3 && (this.timeTrigger[7] = this.timePassed, this.timeTrigger[8] = this.timePassed, this.timeTrigger[9] = this.timePassed), e == 4 && (this.timeTrigger[10] = this.timePassed)
            },
            startTimer() {
